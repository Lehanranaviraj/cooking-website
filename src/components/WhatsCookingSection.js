...
function WhatsCookingSection() {
  return (
    <section className="whats-cooking">
      <div className="container">
        ...
        <div className="content">
          ...
          <p>
            Whether you're craving spicy curries, sweet desserts, or savory
            snacks, I offer a variety of hands-on cooking classes tailored to
            your taste.
          </p>
        </div>
      </div>
...
export default WhatsCookingSection;